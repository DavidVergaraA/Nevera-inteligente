...
#-----Titulo-----
titulo = Label(Ayuda_ventana, text= "Ayuda", font= Ayudas.titulo, bg= Ayudas.azul_hielo, fg= Ayudas.negro_letra)
titulo.place(relx=0.50, rely=0.08)

#-----Logo-----
ImgInterrogacion = ImageTk.PhotoImage(Image.open("Imagenes/interrogacion.png"))
LogoInterrogacion = Label (image = ImgInterrogacion,height = 70 , width= 70, bg= Ayudas.azul_hielo)
