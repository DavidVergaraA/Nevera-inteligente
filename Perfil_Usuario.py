...
perfil_Usuario.configure(background = Ayudas.azul_claro)
...
#-----Titulo-----
titulo = Label(perfil_Usuario, text= "Perfil del usuario", font= Ayudas.titulo, bg= Ayudas.azul_claro, fg= Ayudas.negro_letra)
titulo.place(relx = 0.41, rely = 0.06)

#-----Imagen-----
ImgCara = ImageTk.PhotoImage(Image.open("Imagenes/cara.png"))
ImagenCara = Label (image = ImgCara,bg = Ayudas.azul_claro,height = 180 , width = 210)
ImagenCara.place(relx = 0.18, rely = 0.2)

#-----Labels-----
txtNombre = Label (text = "Nombre: ", bg = Ayudas.azul_claro , font = Ayudas.subtitulo  )
...
txtCorreo = Label (text = "Correo: ", bg = Ayudas.azul_claro , font = Ayudas.subtitulo  )
